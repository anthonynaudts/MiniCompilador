...
_lr_productions = [
  ...
  ('statement_list -> statement statement_list','statement_list',2,'p_statement_list','parser.py',12),
  ...
  ('statement -> print_statement','statement',1,'p_statement','parser.py',23),
  ('declaration -> TYPE ID SEMICOLON','declaration',3,'p_declaration','parser.py',27),
  ('declaration -> TYPE ID ASSIGN expression SEMICOLON','declaration',5,'p_declaration','parser.py',28),
  ('assignment -> ID ASSIGN expression SEMICOLON','assignment',4,'p_assignment','parser.py',39),
  ('if_statement -> IF LPAREN expression RPAREN LBRACE statement_list RBRACE ELSE LBRACE statement_list RBRACE','if_statement',11,'p_if_statement','parser.py',45),
  ('if_statement -> IF LPAREN expression RPAREN LBRACE statement_list RBRACE','if_statement',7,'p_if_statement','parser.py',46),
  ('print_statement -> PRINT LPAREN expression RPAREN SEMICOLON','print_statement',5,'p_print_statement','parser.py',53),
  ...
  ('expression -> expression LT term','expression',3,'p_expression','parser.py',60),
  ('expression -> expression LE term','expression',3,'p_expression','parser.py',61),
  ('expression -> expression EQ term','expression',3,'p_expression','parser.py',62),
  ('expression -> expression GT term','expression',3,'p_expression','parser.py',63),
  ('expression -> expression GE term','expression',3,'p_expression','parser.py',64),
  ('expression -> expression NE term','expression',3,'p_expression','parser.py',65),
  ('term -> factor','term',1,'p_term','parser.py',72),
  ('term -> term MULTIPLY factor','term',3,'p_term','parser.py',73),
  ('term -> term DIVIDE factor','term',3,'p_term','parser.py',74),
  ('factor -> NUMBER','factor',1,'p_factor','parser.py',81),
  ('factor -> STRING','factor',1,'p_factor','parser.py',82),
  ('factor -> ID','factor',1,'p_factor','parser.py',83),
]
